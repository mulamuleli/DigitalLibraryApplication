...
namespace DigitalLibraryApplication.Controllers
{
    public class AudioBookManualController : Controller
    {
        ...
        {
            return View();
            // these view is defined in AudioBookManual folder in the Create.
            // this funciton is simply just returning a view
        ...
        // the function above is handling the creation of the audio book
        // we also implemented tes for handling bad data
