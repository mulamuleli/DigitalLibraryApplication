...
namespace DigitalLibraryUnitTests
{
    public class AudioBookManualControllerTests
    {
        ...
        /*  our fist test is handling all the implementation in the Create function of the 
            *  AudioBookManualController. which is also retruning a view*/
        ...
        // this test will handle the real cretion
        [Fact]
